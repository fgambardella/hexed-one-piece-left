...
Only one piece left! Can you solve it?

HEXED: One Piece Left
It fits... until it doesn’t.

Welcome to HEXED, the deceptively simple puzzle game that will challenge your spatial logic and test your patience.

The premise is easy: fit a set of colorful, geometric shapes (polyiamonds) into a hexagonal grid. No gaps, no overlaps. Just pure, satisfying geometry.
...
Don't just play a puzzle. Master the geometry. Can you find the solution, or will you be left with just One Piece Left?